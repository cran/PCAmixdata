#' @export
#' @title Coefficient RV
#' @name RV
#' @description Compute a data fame with all the RV coefficients between each matrix of a list 
#' @param liste.mat a list of \code{G} matrix
#' @return \item{RV}{a data frame with \code{G} rows and \code{G} colums with all the RV coefficients}
#' 
#' @examples
#' V0<-c("a","b","a","a","b")
#' V01<-c("c","d","e","c","e")
